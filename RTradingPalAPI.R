...
# -- ----------------------------------------------------------------------------------------- -- #
# -- Desarrollador Inicial: Francisco@tradingpal.com ----------------------------------------- -- #
# -- Mantiene: Francisco@tradingpal.com ------------------------------------------------------ -- #
# -- Languaje: R ----------------------------------------------------------------------------- -- #
# -- GitHub:  https://github.com/TradingPal/R_TradingPal_API --------------------------------- -- #
# -- License: TradingPal 2017 ---------------------------------------------------------------- -- #
# -- ----------------------------------------------------------------------------------------- -- #
...
TP_CloseTrade <- function(P0_Token,P1_tradeID)  {
...
# -- ------------------------------------------------------------------------------------ ------- #
# --  Funciones que utilizan TRADERS TRUST API -------------------------------------------------- #
# -- ------------------------------------------------------------------------------------ ------- #

TP_GetAccountInfo_TT <- function()  {
  
  http1 <- "http://ttcm-api-demo.ttcm.com/accounts/2088540374"
  # Authorization: Basic MzgxOmwxdmxvbWc=
  Datos
